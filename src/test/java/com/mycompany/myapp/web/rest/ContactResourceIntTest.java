...
public class ContactResourceIntTest {
    ...
    private static final ContactStatus DEFAULT_STATUS = ContactStatus.ACTIVE;
    private static final ContactStatus UPDATED_STATUS = ContactStatus.INACTIVE;
    ...
    public void setup() {
        ...
        final ContactResource contactResource = new ContactResource(contactRepository, groupRepository);
    ...
    public void createContact() throws Exception {
        ...
        assertThat(testContact.getEmail()).isEqualTo(DEFAULT_EMAIL_ID);
    ...
    public void updateContact() throws Exception {
        ...
        assertThat(testContact.getEmail()).isEqualTo(UPDATED_EMAIL_ID);

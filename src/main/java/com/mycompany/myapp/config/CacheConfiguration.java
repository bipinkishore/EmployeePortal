...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            cm.createCache(com.mycompany.myapp.domain.Group.class.getName(), jcacheConfiguration);
            cm.createCache(com.mycompany.myapp.domain.Contact.class.getName(), jcacheConfiguration);
            cm.createCache(com.mycompany.myapp.domain.Group.class.getName() + ".contacts", jcacheConfiguration);
            cm.createCache(com.mycompany.myapp.domain.Contact.class.getName() + ".groups", jcacheConfiguration);
